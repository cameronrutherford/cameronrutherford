...
```{.Dockerfile include="../../.devcontainer/Dockerfile" start-line=26 end-line=32}
```

#### GitHub actions and pdf

Unfortunately the first pipeline I tried with pdf backend enabled also needed some TeX engine installed - [https://github.com/CameronRutherford/CameronRutherford/actions/runs/5774702232/job/15651941247](https://github.com/CameronRutherford/CameronRutherford/actions/runs/5774702232/job/15651941247)
