...
<table>
  <thead>
    <tr>
      <th>
        <p class="text-center">
          <a class="btn btn-primary btn-lg cv-download" href="cpp_resume.pdf" target="_blank"> <i class="fa-solid fa-file-arrow-down"></i> Download current C++ resume </a>
        </p>
      </th>
      <th> <p class="text-center">
          <a class="btn btn-primary btn-lg cv-download" href="python_resume.pdf" target="_blank"> <i class="fa-solid fa-file-arrow-down"></i> Download current Python resume </a>
        </p>
      </th>
      <th>
        <p class="text-center">
          <a class="btn btn-primary btn-lg cv-download" href="devops_resume.pdf" target="_blank"> <i class="fa-solid fa-file-arrow-down"></i> Download current DevOps resume  </a>
        </p>
      </th>
    </tr>
  </thead>
