...
- Led Software Stack for ExaSGD project to Frontiner deployment C++ / HIP (current world #1 HPC System)
...
- Successfully scaled ExaSGD C++ / MPI software to Summit (former world #1 HPC System)
...
- Interfaced HiOp linear solver into ExaGO for first ever (SC-)ACOPF solved on GPU
